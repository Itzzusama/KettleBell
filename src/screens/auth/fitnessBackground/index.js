  ...
  const handleNext = () => {
    dispatch(
      updateUserData({
        fitnessBackground: {
          activityLevel:
            selectedActivityLevel.charAt(0).toUpperCase() +
            selectedActivityLevel.slice(1),
      ...
      >
        <ScrollView contentContainerStyle={styles.content}>
          <Text style={styles.sectionTitle}>
            {t("FitnessBackground.sectionTitle")}
          </Text>
          <Text style={styles.subtitle}>{t("FitnessBackground.subtitle")}</Text>
          {/* Gender Selection */}
          <Text style={styles.label}>
            {t("FitnessBackground.fitnessLevel")}
          </Text>
          ...
          {/* Activity Level */}
          <Text style={styles.label}>
            {t("FitnessBackground.activityLevel")}
          </Text>
          ...
          <Text style={styles.questionText}>
            {t("FitnessBackground.exerciseFrequency")}
          </Text>
          <CustomInput
          ...
          <Text style={styles.label}>
            {t("FitnessBackground.exerciseHistory")}
          </Text>
          <CustomInput
          ...
          <View style={styles.buttonContainer}>
            <CustomButton
              title={t("FitnessBackground.next")}
              onPress={handleNext}
            />
          </View>
        </ScrollView>
