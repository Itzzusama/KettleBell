      ...
      >
        ...
        <View style={styles.profileSection}>
          ...
          <Text style={styles.profileName}>
            {client?.name || "Madison Smith"}
          </Text>
          <Text style={styles.profileEmail}>
            {client?.email || "madisons@example.com"}
          </Text>
        </View>
        ...
        <View style={styles.sectionContainer}>
          ...
          <TouchableOpacity style={styles.menuItem}>
            <View style={styles.menuItemLeft}>
              ...
              <Text style={styles.menuItemText}>
                {t("clientProfile.bmr_calculator")}
              </Text>
            </View>
            <Ionicons
          ...
          >
            <View style={styles.menuItemLeft}>
              ...
              <Text style={styles.menuItemText}>
                {t("clientProfile.workout_progress")}
              </Text>
            </View>
            <Ionicons
              name="chevron-forward"
        ...
        <View style={styles.sectionContainer}>
          ...
          <View style={styles.menuItem}>
            <View style={styles.menuItemLeft}>
              ...
              <Text style={styles.menuItemText}>
                {t("clientProfile.pop_up_notification")}
              </Text>
            </View>
            <TouchableOpacity
              style={[
        ...
        <View style={styles.sectionContainer}>
          ...
          <TouchableOpacity style={styles.menuItem}>
            <View style={styles.menuItemLeft}>
              ...
              <Text style={styles.menuItemText}>
                {t("clientProfile.privacy_policy")}
              </Text>
            </View>
            <Ionicons
              name="chevron-forward"
