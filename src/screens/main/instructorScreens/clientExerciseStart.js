      ...
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.content}>
          ...
          <View style={styles.titleSection}>
            <Text style={styles.exerciseTitle}>{t("clientExerciseStart.title")}</Text>
            <Text style={styles.exerciseDescription}>
              {t("clientExerciseStart.desc")}
            </Text>
            <Text style={{color: COLORS.primaryColor, fontFamily: fonts.regular, fontSize: hp(2)}}>{t("clientExerciseStart.time")}: 9:00 am</Text>
          </View>
          ...
          >
            ...
            <CustomButton title={t("clientExerciseStart.done")} onPress={() => navigation.navigate(RouteName.Instructor_Tabs)} />
          </ScrollView>
        </View>
      </SafeAreaView>
    </View>
