    ...
    return (
      ...
      >
        ...
        <View style={styles.iconContainer}>
          ...
          >
            <Ionicons name="pencil" size={wp(4)} color={COLORS.primaryColor} />
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.iconButton}
          ...
          >
            <Ionicons name="trash" size={wp(4)} color={COLORS.primaryColor} />
          </TouchableOpacity>
        </View>
      </TouchableOpacity>
    );
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate(RouteName.Add_Recipe)}
