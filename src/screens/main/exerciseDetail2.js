        ...
        <View style={styles.infoContainer}>
          ...
          <View style={{ marginVertical: hp(2) }}>
            ...
            >
              ...
              >
                ...
                <Text style={styles.detailLabel}>
                  {t("ExerciseDetail2.category_label")}
                </Text>
              </View>
              <Text style={styles.detailValue}>{exercise?.category?.name}</Text>
            </View>
            <View
              style={{
                borderWidth: 0.5,
            ...
            >
              ...
              >
                <Image source={Images.dumble} style={styles.detailImage} />
                <Text style={styles.detailLabel}>
                  {t("ExerciseDetail2.difficulty_label")}
                </Text>
              </View>
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>
              {t("ExerciseDetail2.target_muscles_title")}
            </Text>
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>
              {t("ExerciseDetail2.equipment_title")}
            </Text>
            <View style={styles.tagsContainer}>
          ...
          <View style={styles.section2}>
            <View style={styles.instructionsContainer}>
              <Text style={styles.instructionsTitle}>
                {t("ExerciseDetail2.instructions_title")}
              </Text>
