...
export const AuthStack = () => {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen
        name={RouteName.Reset_SuccessFully}
        component={ResetSuccessFull}
      />
      <Stack.Screen name={RouteName.Fitness_Coach} component={FitnessCoach} />
      <Stack.Screen
        name={RouteName.Basic_Information}
        component={BasicInformation}
      />
      <Stack.Screen
        name={RouteName.Body_Measurements}
        component={BodyMeasurements}
      />
      <Stack.Screen
        name={RouteName.Health_Information}
        component={HealthInformation}
      />
      <Stack.Screen
        name={RouteName.Fitness_Background}
        component={FitnessBackground}
      />
